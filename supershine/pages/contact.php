...
<head>
    ...
    <title>Supershine | Contact</title>
</head>
<body>
    <header>
    ...
    <div class="container">
        <div class="content">
            ...
            <?php if(isset($_SESSION['errors'])){ ?>
                        ...
                        <?php } ?>
                <form action="./../admin/actions/post_comment.php" method="post">
                    <div class="inputs">
                        <div class="two">
                            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" name="phone" id="contact" placeholder="Email or Phone Number">
                        </div>

                        <div class="mb-3">
                            <textarea class="form-control" max="500" rows="3" name="comment" id="comment" placeholder="Drope a Comment or Message..."></textarea>
                        </div>

                        <button type="submit" name="submit" class="btn btn-primary" (click)="postRequest()">Submit</button>
                    </div>
                </form>
