                ...
                <div class="member">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                                echo "<td>";
                                echo '<a href="/supershine/admin/details/member.php?param='.$row['id'].'">';
                            ...
                            echo '<td class="cta">';
                            echo '<a href="/supershine/admin/details/member.php?param='.$row['id'].'" class="btn edit">';
                                ...
                                echo '</svg>';
                            echo '</a>';
                            echo '<a href="/supershine/admin/actions/delete_member.php?param='.$row['id'].'" class="btn delete">';
