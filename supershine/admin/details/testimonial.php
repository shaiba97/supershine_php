...
<body>
    ...
    <div class="wrappers">
        ...
        <div class="uploads testimonial">
                ...
                <div class="testimonial-detail details">
                <div class="back mb-3">
                            <a href="/supershine/admin/elements/testimonials.php">
                         ...
                         if ($row = $result->fetch_assoc()) {?>
                            <div class="images row">
                                <div class="image col-6">
                                    <img src="../uploaded_image/testimonials/<?php echo $row['beforeImage'] ?>" class="rounded mx-auto d-block img-fluid img-fluid img-thumbnail rounded" alt="">
                                </div>
                                <div class="image col-6">
                                    <img src="../uploaded_image/testimonials/<?php echo $row['afterImage'] ?>" class="rounded mx-auto d-block img-fluid img-fluid img-thumbnail rounded" alt="">
                                </div>
                            </div>
                            <?php }?>
                </div>
